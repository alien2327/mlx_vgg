...
from .params import VGG16_WEIGHTS_LINK
...
class VGG16(nn.Module):
    def __init__(
        ...
        # conv_block_4
        self.block4_conv1 = nn.Conv2d(256, 512, kernel_size=3, padding=1) #  8
        self.block4_conv2 = nn.Conv2d(512, 512, kernel_size=3, padding=1) #  9
        self.block4_conv3 = nn.Conv2d(512, 512, kernel_size=3, padding=1) # 10
        self.block4_pool   = nn.MaxPool2d(kernel_size=2, stride=2)
        
        # conv_block_5
        self.block5_conv1 = nn.Conv2d(512, 512, kernel_size=3, padding=1) # 11
        self.block5_conv2 = nn.Conv2d(512, 512, kernel_size=3, padding=1) # 12
        self.block5_conv3 = nn.Conv2d(512, 512, kernel_size=3, padding=1) # 13
        ...
        if is_classifier:
            ...
            # fc_block
            self.fc1 = nn.Linear(fc_dim, 4096)                            # 14
